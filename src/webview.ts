  ...
  setState(state: ViewState): void {
    ...
    if (this.view && previous.kind === 'loading' && state.kind === 'loading') {
      ...
      void this.view.webview.postMessage({
        ...
        previewHtml: previewContent(state.source, state.preview), attempt: state.attempt
      });
      return;
    }
    this.render();
